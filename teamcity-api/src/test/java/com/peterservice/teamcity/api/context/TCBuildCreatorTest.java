package com.peterservice.teamcity.api.context;

import com.peterservice.teamcity.api.builds.TCBuildCreator;
import com.peterservice.teamcity.api.context.impl.SafHttpRequest;
...
public class TCBuildCreatorTest {
    ...
    public void CreateBuilds() throws JAXBException {
        TCBuildCreator tcBuildCreator = new TCBuildCreator("any_product", "12", "teamcity.billing.ru", "olga.lugacheva", "sgalbgr8");
        BuildType buildType = null;
        try {
            buildType = tcBuildCreator.createBuildFromTemplate("RS_Prepare_Install_RHEL7", "Etp_LugachevaOlga_InstallerTest_RsPrepareInstallRhel7",
    ...
    @Test
    public void PushBuilds() throws Exception {
        TCBuildCreator tcBuildCreator = new TCBuildCreator("some_name_product", "x123", "teamcity.billing.ru", "olga.lugacheva", "sgalbgr8");
        tcBuildCreator.pushBuildToTC("Base_test_template", "Etp_LugachevaOlga_InstallerTest_BaseTestTemplate", "Installer_test", "Etp_LugachevaOlga_InstallerTest");
    }
